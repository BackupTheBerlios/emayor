...
public class ResolverDirectHTTP extends ResourceResolverSpi {
   ...
   public XMLSignatureInput engineResolve(Attr uri, String BaseURI)
      ...
      try {
         ...
         if (useProxy) {
            if (false)
            	System.out.println("Use of HTTP proxy enabled: " + proxyHost + ":"
                      + proxyPort);
...

         {
            ...
            if ((proxyUser != null) && (proxyPass != null)) {
               ...
               String encodedPassword = Base64.encode(password.getBytes("UTF-8"));
               ...
               if (auth.startsWith("Basic")) {
                  ...
                  if ((user != null) && (pass != null)) {
                     ...
                     String encodedPassword =
                        Base64.encode(password.getBytes("UTF-8"));
         ...
         System.out.println("Fetched " + summarized + " bytes from URI "
                   + uriNew.toString());
   ...
   public boolean engineCanResolve(Attr uri, String BaseURI) {
      ...
      if (uri == null) {
         System.out.println("quick fail, uri == null");
      ...
      if (uriNodeValue.equals("") || uriNodeValue.startsWith("#")) {
         System.out.println("quick fail for empty URIs and local ones");
      ...
      if ((uriNew != null) && uriNew.getScheme().equals("http")) {
         if (false)
        	System.out.println("I state that I can resolve " + uriNew.toString());

         return true;
      }

      if (false)
      	System.out.println("I state that I can't resolve " + uriNew.toString());
