...
public class HexDump {
    ...
    * @return hexdump string
    */
   public static String prettyPrintHex(String sToConvert) throws Exception
   {
      return prettyPrintHex(sToConvert.getBytes("UTF-8"));
   }
    ...
    */
   public static String stringToHexString(String in) throws Exception
   {
   ...
   public static void main(String args[]) {
     try
     {
      ...
      byte[] ba = str.getBytes(); // any encoding ok for "Niko"
