...
public class Reference extends SignatureElementProxy {
   ...
   public XMLSignatureInput getTransformsInput() throws ReferenceNotInitializedException   
	{  
		...
		try {
			result = new XMLSignatureInput(input.get_Bytes());
   ...
   private XMLSignatureInput getContentsAfterTransformation(XMLSignatureInput input, OutputStream os)
      ...
      try {
         ...
         if (transforms != null) {
            ...
            this._transformsOutput = output;//new XMLSignatureInput(output.getBytes("UTF-8"));
   ...
   public byte[] getReferencedBytes()
    ...
    try {
        ...
        byte[] signedBytes = output.get_Bytes();
   ...
   public boolean verify()
      ...
      if (!equal) {
      System.out.println("Verification failed for URI \"" + this.getURI() + "\"");
      } else {
         System.out.println("Verification successful for URI \"" + this.getURI() + "\"");
      }
