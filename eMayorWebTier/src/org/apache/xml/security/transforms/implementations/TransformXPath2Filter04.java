...
public class TransformXPath2Filter04 extends TransformSpi {
   ...
   protected XMLSignatureInput enginePerformTransform(XMLSignatureInput input)
      ...
      try {
         ...
         if (false)
         	System.out.println("perform xfilter2 on " + inputSet.size() + " nodes");
         ...
         if (false)
         	System.out.println("subtreeRoots contains " + subtreeRoots.getLength()
                   + " nodes");
         ...
         if (false)
         	System.out.println("selection process identified " + selectedNodes.size()
                   + " nodes");
