   ...
   private void traversal(Node currentNode) {
      ...
      searchFirstUnionWhichContainsNode: for (i = iMax - 1; i >= 0; i--) {
         ...
         if ((type == FUnion)
            ...
            if (currentNode.getNodeType() == Node.ELEMENT_NODE) {
               System.out.println(i + " " + ((Element) currentNode).getTagName()
      ...
      for (int I = IStart; I < iMax; I++) {
         ...
         if ((type == FIntersect) &&!rooted) {
            ...
            /*
            if (currentNode.getNodeType() == Node.ELEMENT_NODE) {
               System.out.println("The intersect operation from step " + I
            ...
            */
            ...
            /*
            if (currentNode.getNodeType() == Node.ELEMENT_NODE) {
               System.out.println("The subtract operation from step " + I
