...
public class KeyInfo extends SignatureElementProxy {
   ...
   public PublicKey getPublicKey() throws KeyResolverException {
      ...
      if (pk != null) {
         System.out.println("I could find a key using the per-KeyInfo key resolvers");

         return pk;
      } 
      System.out.println("I couldn't find a key using the per-KeyInfo key resolvers");      

      pk = this.getPublicKeyFromStaticResolvers();

      if (pk != null) {
         System.out.println("I could find a key using the system-wide key resolvers");

         return pk;
      }
      System.out.println("I couldn't find a key using the system-wide key resolvers");      
   ...
   PublicKey getPublicKeyFromInternalResolvers() throws KeyResolverException {
      ...
      for (int i = 0; i < this.lengthInternalKeyResolver(); i++) {
         ...
         if (false)
         	System.out.println("Try " + keyResolver.getClass().getName());
   ...
   X509Certificate getX509CertificateFromStaticResolvers()
           throws KeyResolverException {
      if (false)
      	System.out.println("Start getX509CertificateFromStaticResolvers() with "
   ...
   X509Certificate getX509CertificateFromInternalResolvers()
           throws KeyResolverException {
      if (false)
      	System.out.println("Start getX509CertificateFromInternalResolvers() with "
   ...
   public SecretKey getSecretKey() throws KeyResolverException {
      ...
      if (sk != null) {
         System.out.println("I could find a secret key using the per-KeyInfo key resolvers");

         return sk;
      } 
      System.out.println("I couldn't find a secret key using the per-KeyInfo key resolvers");
      

      sk = this.getSecretKeyFromStaticResolvers();

      if (sk != null) {
         System.out.println("I could find a secret key using the system-wide key resolvers");

         return sk;
      } 
      System.out.println("I couldn't find a secret key using the system-wide key resolvers");
