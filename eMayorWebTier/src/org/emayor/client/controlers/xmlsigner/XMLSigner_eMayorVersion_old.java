...
public class XMLSigner_eMayorVersion_old 
{
  ...
  public XMLSigner_eMayorVersion_old( final EMayorFormsClientApplet _clientApplet )
  {  	
  ...
  public String signTheDocument( final String xmlDocument ) throws Exception
  {
    ...
    if( doContinue )
    {
      ...
      {        
        ...
        ByteArrayInputStream inF = new java.io.ByteArrayInputStream(xmlDocument.getBytes("UTF-8"));
