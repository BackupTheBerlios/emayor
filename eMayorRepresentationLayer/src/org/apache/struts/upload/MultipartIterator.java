/*
 * $Id: MultipartIterator.java,v 1.1 2006/02/01 15:33:05 emayor Exp $ 
 *
...
public class MultipartIterator
{
     ...
     */
    public MultipartIterator(HttpServletRequest request) throws Exception
    {
        this(request, -1);
    }
     ...
     *                   stream at a times
     */
    public MultipartIterator(HttpServletRequest request, int bufferSize) throws Exception
    {
     ...
     */
    public MultipartIterator(HttpServletRequest request, int bufferSize, long maxSize) throws Exception
    {
        this(request, bufferSize, maxSize, null);
    }

    public MultipartIterator(HttpServletRequest request, int bufferSize, long maxSize, String tempDir) throws Exception
    {
