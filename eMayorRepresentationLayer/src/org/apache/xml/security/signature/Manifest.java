...
public class Manifest extends SignatureElementProxy {
   ...
   public boolean verifyReferences(boolean followManifests)
      ...
      if (_referencesEl==null) {
        this._referencesEl =  
   	  ...
   	  if (false) {
   	  	System.out.println("verify " +_referencesEl.length + " References");
        System.out.println("I am " + (followManifests
                           ? ""
      ...
      for (int i =
         ...
         try {
            ...
            if (false)
            	System.out.println("The Reference has Type " + currentRef.getType());
            ...
            if (verify && followManifests
               ...
               System.out.println("We have to follow a nested Manifest");
                ...
                try {
                  ...
                  if (!referencedManifestValid) {
                     ...
                     System.out.println("The nested Manifest was invalid (bad)");
                  } else {
                     System.out.println("The nested Manifest was valid (good)");
                  }
   ...
   public byte[] getSignedContentItem(int i) throws XMLSignatureException {
      ...
      try {
         return this.getReferencedContentAfterTransformsItem(i).get_Bytes();
      } catch (IOException ex) {
