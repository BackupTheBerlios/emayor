  ...
  /**
   ...
   public boolean checkSignatureValue(Key pk) throws XMLSignatureException {
      ...
      try {
         ...
         if (false) {
         	System.out.println("SignatureMethodURI = " + sa.getAlgorithmURI());
         	System.out.println("jceSigAlgorithm    = " + sa.getJCEAlgorithmString());
         	System.out.println("jceSigProvider     = " + sa.getJCEProviderName());
