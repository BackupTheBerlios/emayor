...
public class XMLCipherInput {
	...
	public byte[] get_Bytes() throws XMLEncryptionException {
	...
	private byte[] getDecryptBytes() throws XMLEncryptionException {
        ...
        if (_cipherData.getDataType() == CipherData.REFERENCE_TYPE) {
			// Fun time!
			System.out.println("Found a reference type CipherData");
			...
			if (input != null) {
				System.out.println("Managed to resolve URI \"" + cr.getURI() + "\"");
			}
			else {
				System.out.println("Failed to resolve URI \"" + cr.getURI() + "\"");
			}
		
			// Lets see if there are any transforms
			Transforms transforms = cr.getTransforms();
			if (transforms != null) {
				System.out.println("Have transforms in cipher reference");
				try {
