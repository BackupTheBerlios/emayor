...
public class Transforms extends SignatureElementProxy {
   ...
   public void addTransform(String transformURI)
      ...
      try {
         if (false)
         	System.out.println("Transforms.addTransform(" + transformURI + ")");
   ...
   private void addTransform(Transform transform) {
      if (false)
      	System.out.println("Transforms.addTransform(" + transform.getURI() + ")");
      ...
      try {
        ...
        int last=transformLength-1;
         for (int i = 0; i < transformLength; i++) {
            ...
            if (false) {
            	System.out.println("Preform the (" + i + ")th " + t.getURI() + " transform");
            }
            if (i==last) {
