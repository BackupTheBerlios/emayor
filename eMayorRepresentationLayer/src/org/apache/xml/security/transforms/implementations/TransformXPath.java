         ...
         while (iterator.hasNext()) {
            ...
            */            
            ...
            if (includeInResult.bool()) {
               ...
               // System.out.println("    Added " + org.apache.xml.security.c14n.implementations.Canonicalizer20010315.getXPath(currentNode));
             } else {
               // System.out.println("Not added " + org.apache.xml.security.c14n.implementations.Canonicalizer20010315.getXPath(currentNode));
            }
         }
