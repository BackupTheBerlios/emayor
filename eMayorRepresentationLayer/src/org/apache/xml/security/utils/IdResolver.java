...
public class IdResolver {
   ...
   public static Element getElementById(Document doc, String id) {
      ...
      if (result != null) {
         System.out.println("I could find an Element using the XKMS searcher method: "
                   + result.getTagName());
    ...
    private static Element getElementByIdUsingDOM(Document doc, String id) {
        if (false)
        	System.out.println("getElementByIdUsingDOM() Search for ID " + id);
   ...
   private static Element getElementByIdType(Document doc, String id) {
   	  if (false)
   	  	System.out.println("getElementByIdType() Search for ID " + id);
       WeakHashMap elementMap = (WeakHashMap) docMap.get(doc);
       if (elementMap != null) {
   ...
   private static Element getElementByIdInDSNamespace(Document doc, String id
            ,CachedXPathAPI cx) {
   	  if (false)
   	  	System.out.println("getElementByIdInDSNamespace() Search for ID " + id);
      ...
      try {
         ...
         System.out.println("Found ds:Elements: " + dsElements.getLength());
   ...
   private static Element getElementByIdInXENCNamespace(Document doc,
      ...
      if (false)
      	System.out.println("getElementByIdInXENCNamespace() Search for ID " + id);
   ...
   private static Element getElementByIdInSOAPSignatureNamespace(Document doc,
           String id, CachedXPathAPI cx) {
   	  if (false)
   	  	System.out.println("getElementByIdInSOAPSignatureNamespace() Search for ID " + id);
   ...
   private static Element getElementByIdInXKMSNamespace(Document doc,
      ...
      */
   	  if (false)
   	  	System.out.println("getElementByIdInXKMSNamespace() Search for ID " + id);
   ...
   private static Element getElementByIdUnsafeMatchByIdName(Document doc,
           String id, CachedXPathAPI cx) {
   	  if (false)
   	  	System.out.println("getElementByIdUnsafeMatchByIdName() Search for ID " + id);
