  ...
  */ 
   ...
   */ 
    ...
    */ 
     ...
     */ 
     public String getProcessStepTextListForRequest()
     {
     ...
     *  @return comma separated list of texts for each step.
     */ 
     public String getProcessStepDescriptionListForRequest()
     {
       StringBuffer textList = new StringBuffer();
     ...
     */ 
     public String getProcessStepIndexForRequest()
     {
      ...
      *  @return comma separated list of texts for each step.
      */ 
      public String getProcessStepTextListForResultDocument()
      {
        StringBuffer textList = new StringBuffer();
        textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SelectDocument) );
        textList.append( ";" );
        textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_ViewDocument) );
        textList.append( ";" );
        textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SaveDocument) );
        return textList.toString();
      }
      ...
      *  @return comma separated list of texts for each step.
      */ 
      public String getProcessStepDescriptionListForResultDocument()
      {
        StringBuffer textList = new StringBuffer();
        textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SelectDocument_Description) );
        textList.append( ";" );
        textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_ViewDocument_Description) );
        textList.append( ";" );
        textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SaveDocument_Description) );
        return textList.toString();
      }
      ...
      *  @return index of current step (zero based)
      */ 
      public String getProcessStepIndexForResultDocument()
      {
        return "1"; // The second entry
      }
       ...
       *  @return comma separated list of texts for each step.
       */ 
       public String getProcessStepTextListForCivilServantDocument()
       {
         StringBuffer textList = new StringBuffer();
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SelectDocument) );
         textList.append( ";" );
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_ViewDocument) );
         textList.append( ";" );
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_ProcessDocument) );
         return textList.toString();
       }
       ...
       *  @return comma separated list of texts for each step.
       */ 
       public String getProcessStepDescriptionListForCivilServantDocument()
       {
         StringBuffer textList = new StringBuffer();
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SelectDocument_Description) );
         textList.append( ";" );
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_ViewDocument_Description) );
         textList.append( ";" );
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_ProcessDocument_Description) );
         return textList.toString();
       }
       ...
       *  @return index of current step (zero based)
       */ 
       public String getProcessStepIndexForCivilServantDocument()
       {
         return "1"; // The second entry
       }
       ...
       *  @return comma separated list of texts for each step.
       */ 
       public String getProcessStepTextListForRepository()
       {
         StringBuffer textList = new StringBuffer();
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SelectDocument) );
         textList.append( ";" );
       ...
       *  @return comma separated list of texts for each step.
       */ 
       public String getProcessStepDescriptionListForRepository()
       {
         StringBuffer textList = new StringBuffer();
         textList.append( super.getTextFromResource(TextResourceKeys.ProcessStep_SelectDocument_Description) );
         textList.append( ";" );
       ...
       *  @return index of current step (zero based)
       */ 
       public String getProcessStepIndexForRepository()
       {
