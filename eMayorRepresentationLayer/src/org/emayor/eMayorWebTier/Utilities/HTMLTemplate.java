...
public class HTMLTemplate implements Serializable
{
  ...
  private void loadTemplateFromFileSystem( final String municipalityName )
  {
    ...
    if( municipalitiesInformationDirectory.exists() )
    {
      ...
      System.out.println("ExtendedActionForm: MunicipalityInformation2.0 directory found at: " +
    ...
    else
    {
      ...
      System.out.println("ExtendedActionForm: HTML template file is MISSING in the MunicipalityInformation2.0 directory.");
  ...
  *  MunicipalityInformation2.0/municipalityName is used.
  */ 
