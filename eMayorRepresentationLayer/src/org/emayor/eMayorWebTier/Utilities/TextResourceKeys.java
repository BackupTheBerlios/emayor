...
public class TextResourceKeys 
{
 ...
 public final static String LogoutCloseBrowser="Message.LogoutCloseBrowser";
 public final static String LogoutMessage="Message.LogoutInformation";
 ...
 // process step text identifiers:
 public final static String ProcessStep_Login="ProcessStep.Login";
 public final static String ProcessStep_SoftwareCheck="ProcessStep.SoftwareCheck";
 public final static String ProcessStep_Authentication="ProcessStep.Authentication";
 public final static String ProcessStep_MunicipalityIndex="ProcessStep.MunicipalityIndex"; 
 public final static String ProcessStep_FillOutForm="ProcessStep.FillOutForm";
 public final static String ProcessStep_SignAndSubmit="ProcessStep.SignAndSubmit";
 public final static String ProcessStep_Acknowledgment="ProcessStep.Acknowledgment";
 public final static String ProcessStep_ViewDocument="ProcessStep.ViewDocument";
 public final static String ProcessStep_ProcessDocument="ProcessStep.ProcessDocument";
 public final static String ProcessStep_SaveDocument="ProcessStep.SaveDocument";
 public final static String ProcessStep_SelectDocument="ProcessStep.SelectDocument";
 
 // process step description identifiers:
 public final static String ProcessStep_Login_Description="ProcessStep.Login.Description";
 public final static String ProcessStep_SoftwareCheck_Description="ProcessStep.SoftwareCheck.Description";
 public final static String ProcessStep_Authentication_Description="ProcessStep.Authentication.Description";
 public final static String ProcessStep_MunicipalityIndex_Description="ProcessStep.MunicipalityIndex.Description";
 public final static String ProcessStep_FillOutForm_Description="ProcessStep.FillOutForm.Description";
 public final static String ProcessStep_SignAndSubmit_Description="ProcessStep.SignAndSubmit.Description";
 public final static String ProcessStep_Acknowledgment_Description="ProcessStep.Acknowledgment.Description";
 public final static String ProcessStep_ViewDocument_Description="ProcessStep.ViewDocument.Description";
 public final static String ProcessStep_ProcessDocument_Description="ProcessStep.ProcessDocument.Description";
 public final static String ProcessStep_SaveDocument_Description="ProcessStep.SaveDocument.Description";
 public final static String ProcessStep_SelectDocument_Description="ProcessStep.SelectDocument.Description";
 ...
 public final static String FormViewerServiceKey = "Services.FormViewer";
 ...
 //       The FormViewerService only requires tasks from the web tier and client tier.
...
// Custom services [This must be solved in future - these entries couple customization to java programming]
 ...
 // Client software check applet messages:
 public static final String ClientSoftwareChecking_Message = "ClientSoftwareChecking_Message";
 public static final String ClientSoftwareIsUpToDate_Message = "ClientSoftwareIsUpToDate_Message";
 public static final String ClientSoftwareMustBeInstalled_Message = "ClientSoftwareMustBeInstalled_Message";
 public static final String ClientSoftwareMustBeUpdated_Message = "ClientSoftwareMustBeUpdated_Message";
 public static final String ClientSoftwareHasBeenInstalled_Message = "ClientSoftwareHasBeenInstalled_Message";
 public static final String ClientSoftwareHasBeenUpdated_Message = "ClientSoftwareHasBeenUpdated_Message";
 public static final String ClientBrowserRestart_Message = "ClientBrowserRestart_Message";
 public static final String Proceed_Message = "Proceed_Message";
