...
public class DocumentProcessor
{
  ...
  */ 
  public void setEMayorFormModelContentFrom( String input_eDocument )
  {
    ...
    System.out.println("");
    System.out.println("got the following input e-document: ");
    System.out.println("");
    System.out.println(input_eDocument);
    System.out.println("");
    System.out.println("");
    ...
    try
    {
      XML_Node inputModelNode = this.eMayorDocumentParser.translateDocument( new StringBuffer(input_eDocument) );
      ...
      // In the model, take the first child of the Model node, which
      // is the e-document root node:
   ...
   public void setLocalSchemaLocation( final boolean setLocal )
   {
    ...
    if( setLocal )
    {
      ...
      else
      {
        ...
        this.mainApplet.getErrormanager().addErrorMessage( errorLine1, false );
      ...
      if( xsdPosition >= 0 ) // first possibility found
      {
        ...
        String urlPart = "file:///" + this.javaHomeDirectory + "/eMayor2.0" + currentSchemaLocationPath;
      ...
      else
      {
        ...
        if( xsdPosition >= 0 ) // second possibility found
        {
          ...
          String urlPart = "file:///" + this.javaHomeDirectory + "/eMayor2.0/xsd/" + currentSchemaLocationPath;
          urlPart = urlPart.replaceAll(" ", "%20"); // required parser workaround: replace spaces by %20
          this.localSchemaLocationPath = uri + " " + urlPart; // uri + space + url
          // Take out backslashes possibly present in the userHomeDirectory too:
          this.localSchemaLocationPath = this.localSchemaLocationPath.replace('\\','/');
