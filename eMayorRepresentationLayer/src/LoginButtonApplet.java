...
import java.util.StringTokenizer;
  ...
  /*
   *  The task of the LoginButtonApplet is
   *  to check, if the applet is running under
   *  JRE 1.5.0.4+ , which is required for
   *  correct ssl operation required by the
   *  eMayorForms applet.
   *  If the JRE is ok, this applet shows
   *  a login button, which takes the user
   *  to the municipality page.
   *  If this is not the case, the applet
   *  shows a button, which takes the user
   *  to the JRE download page from Sun.
   * 
   *  jpl
   */
