...
<%--
Note: We just don't set
eMayorFormName  (This way, the applet automatically shows a Load-from-disk dialog)
but instead we put the following parameter:
read_eMayorFormFromClient = true
--%>
...
<applet name="org.emayor.RepresentationLayer.ClientTier.EMayorFormsClientApplet"
  ...
  <param name="read_eMayorFormFromClient" value="true"/>
  <param name="postURL" value="/eMayor2.0/service.do?do=processDocumentInFormService"/>
