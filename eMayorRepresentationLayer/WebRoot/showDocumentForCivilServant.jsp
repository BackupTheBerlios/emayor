...
<tr>
  <td>
    <applet name="org.emayor.RepresentationLayer.ClientTier.ProcessStep.ProcessStep_Applet"
        ...
        <param name="ProcessStepTextList" value="<bean:write name="serviceForm" property="processStepTextListForCivilServantDocument"/>"/>
        <param name="ProcessStepDescriptionList" value="<bean:write name="serviceForm" property="processStepDescriptionListForCivilServantDocument"/>"/>
        <param name="ProcessStepIndex" value="<bean:write name="serviceForm" property="processStepIndexForCivilServantDocument"/>"/>
...
<applet name="org.emayor.RepresentationLayer.ClientTier.EMayorFormsClientApplet"
  ...
  <param name="postURL" value="/eMayor2.0/service.do?do=processDocumentProcessedByCivilServant"/>
