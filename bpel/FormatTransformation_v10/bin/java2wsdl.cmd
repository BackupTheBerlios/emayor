...
set CP=%CP%;..\BPEL-INF\lib\TransformerEJB-client.jar;%EJB_JAR%

java -cp %CP% org.apache.axis.wsdl.Java2WSDL -u LITERAL -l "http://localhost:8080/" -o ../FormatTransformation-gen.wsdl org.eMayor.FormatTransformation.interfaces.Transformer
