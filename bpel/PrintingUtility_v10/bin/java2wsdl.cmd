...
set CP=%CP%;..\BPEL-INF\lib\PrinterEJB-client.jar;%EJB_JAR%

java -cp %CP% org.apache.axis.wsdl.Java2WSDL -u LITERAL -l "http://localhost:8080/" -o ../PrintingUtility-gen.wsdl org.eMayor.ServiceHandling.PrintingUtility.interfaces.Printer
