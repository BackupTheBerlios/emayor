				...
				<UrspruenglicheAnforderung>
					...
					<xsl:for-each select="n18:RequesterDetails">
						<bus:RequesterDetails>
							<xsl:for-each select="ed2:CitizenName">
								<edc:CitizenName>
							...
							<xsl:for-each select="ed2:PreferredLanguages">
								<edc:PreferredLanguages>
									<xsl:value-of select="."/>
								</edc:PreferredLanguages>
							</xsl:for-each>
							<xsl:for-each select="ed2:ContactDetails">
								<edc:ContactDetails>
							...
							<xsl:for-each select="ed2:CitizenSex">
								<edc:CitizenSex>
									<xsl:value-of select="."/>
								</edc:CitizenSex>
							</xsl:for-each>
							<xsl:for-each select="ed2:CitizenMaritalStatus">
								<edc:CitizenMaritalStatus>
									<xsl:value-of select="."/>
								</edc:CitizenMaritalStatus>
							</xsl:for-each>
							<xsl:for-each select="ed2:CitizenBirthDetails">
								<edc:CitizenBirthDetails>
									<xsl:for-each select="ed2:DateOfBirth">
										<edc:DateOfBirth>
									...
									<xsl:for-each select="ed2:BirthActNumber">
										<edc:BirthActNumber>
											<xsl:value-of select="."/>
										</edc:BirthActNumber>
									</xsl:for-each>
							...
							<xsl:for-each select="ed2:Nationality">
								<edc:Nationality>
									<xsl:value-of select="."/>
								</edc:Nationality>
							</xsl:for-each>
							<xsl:for-each select="ed2:IdentificationDetails">
								<edc:IdentificationDetails>
									<xsl:for-each select="ed2:IDCardNumber">
										<edc:IDCardNumber>
											<xsl:value-of select="."/>
										</edc:IDCardNumber>
									</xsl:for-each>
									<xsl:for-each select="ed2:PassportNumber">
										<edc:PassportNumber>
											<xsl:value-of select="."/>
										</edc:PassportNumber>
									</xsl:for-each>
					...
					<xsl:for-each select="n18:RequesterAddress">
						<bus:RequesterAddress>
							...
							<xsl:for-each select="ed2:Nucleus">
								<edc:Nucleus>
									<xsl:value-of select="."/>
								</edc:Nucleus>
							</xsl:for-each>
							<xsl:for-each select="ed2:StreetQualifier">
								<edc:StreetQualifier>
									<xsl:value-of select="."/>
								</edc:StreetQualifier>
							</xsl:for-each>
							<xsl:for-each select="ed2:Section">
								<edc:Section>
									<xsl:value-of select="."/>
								</edc:Section>
							</xsl:for-each>
							<xsl:for-each select="ed2:RegistrationSheet">
