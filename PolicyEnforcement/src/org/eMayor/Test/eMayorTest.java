	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			if (myUserProfile==null){
				...
				out.println(myUserProfile.m_S_UserName);
				out.println("</b><p>");
				out.println("<br>");
				out.print("Your Email is: <b>");
				out.println(myUserProfile.m_S_UserEmail);
				out.println("</b><p>");
				out.println("<br>");
				out.print("Your Organisation Unit is: <b>");
				out.println(myUserProfile.m_S_OrganisationUnit);
				out.println("</b><p>");
				out.println("<br>");
				out.print("Your Organisation is: <b>");
				out.println(myUserProfile.m_S_UserOrganisation);
				out.println("</b><p>");
				out.println("<br>");
				out.print("Your State is: <b>");
				out.println(myUserProfile.m_S_UserST);
				out.println("</b><p>");
				out.println("<br>");
				out.print("Your Country is: <b>");
				out.println(myUserProfile.m_S_UserCountry);
				out.println("</b><p>");
				out.println("<br>");
				out.print("Your Roule is: <b>");
				out.println(myUserProfile.m_S_UserRole);
				out.println("</b><p>");
				out.println("<br>");
				out.println("Your Certificate is:");
				out.println(myUserProfile.m_X509_CertChain[0].toString());
				out.println("<p>");
				out.println("<br>");
