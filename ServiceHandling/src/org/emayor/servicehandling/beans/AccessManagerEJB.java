...
public class AccessManagerEJB implements SessionBean, IAccess {
	 ...
	 * @see IAccess#createAccessSession()
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#startService(String, String)
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#startService(String, String, String)
	 */
	public String startService(String accessSessionId, String serviceId,
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#stopService(String, String)
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#listAvailableServices(String)
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#listRunningServices(String)
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#stopAccessSession(String)
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#startForwardedService(String, String, ForwardMessage)
	 */
	public String startForwardedService(String accessSessionId,
		...
		try {
			...
			if (log.isDebugEnabled())
				log.debug("got access session with id: " + as.getSessionId());
			String[] allDocuments = message.getDocuments().getItem();
			String allAsString = new String();
			for (int i=1;i<allDocuments.length;i++) {
				allAsString += allDocuments[i]+"__EMAYORSPLIT__";
			}
			ret = as.startServiceSession(serviceId, true, message
					.getDocuments().getItem(0), allAsString);
			if (log.isDebugEnabled())
				log.debug("started service ssid = " + ret);
		} catch (KernelException ex) {
			log.error("caught ex: " + ex);
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#startAccessSession(String, X509Certificate[])
	 */
	 ...
	 * 
	 * @ejb.interface-method view-type = "local"
	 * @see IAccess#getUserProfile(String)
	 */
