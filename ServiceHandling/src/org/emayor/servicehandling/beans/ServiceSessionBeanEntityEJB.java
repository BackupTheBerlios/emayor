 ...
 * @ejb.finder method-intf = "LocalHome" query = "SELECT OBJECT(o) FROM
 *             ServiceSessionBeanEntity AS o" result-type-mapping = "Local"
 *             signature = "java.util.Collection findAll()"
 * @ejb.finder method-intf = "LocalHome" query = "SELECT o.ssid FROM
 *             ServiceSessionBeanEntity AS o" result-type-mapping = "Local"
 *             signature = "java.util.Collection findAllSsids()"
 */
