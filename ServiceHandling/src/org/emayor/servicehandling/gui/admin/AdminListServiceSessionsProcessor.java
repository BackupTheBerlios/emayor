 ...
 * @author tku
 */
public class AdminListServiceSessionsProcessor extends AbstractRequestProcessor {
	private static final Logger log = Logger
			.getLogger(AdminListServiceSessionsProcessor.class);
	...
	public String process(HttpServletRequest req, HttpServletResponse resp)
		...
		if (session == null) {
			...
			try {
				...
				session.setAttribute("SERVICE_SESSION_INFO_ARRAY", infos);
				ret = "admin/ListOfServiceSessions.jsp";
				admin.remove();
				...
				AdminErrorPageData data = new AdminErrorPageData();
				data
						.setPageTitle("Couldn't list the running service sessions.");
				session.setAttribute(AdminErrorPageData.ATT_NAME, data);
				ret = "admin/ErrorPage.jsp";
