 ...
 * @author tku
 */
public class AdminUndeployServiceProcessor extends AbstractRequestProcessor {
	private static final Logger log = Logger
			.getLogger(AdminUndeployServiceProcessor.class);
	...
	public String process(HttpServletRequest req, HttpServletResponse resp)
		...
		if (session == null) {
			...
			try {
				...
				data.setMessage("Couldn't undeploy the specified service.");
				session.setAttribute(AdminErrorPageData.ATT_NAME, data);
				ret = "admin/ErrorPage.jsp";
