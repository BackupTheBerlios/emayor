 ...
 * @author tku
 */
public class AdminRemoveAccessSessionProcessor extends AbstractRequestProcessor {
    private static final Logger log = Logger
            .getLogger(AdminRemoveAccessSessionProcessor.class);
    ...
    public String process(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (session == null) {
            ...
            try {
                ...
                admin.removeAccessSession(asid);
                admin.remove();
                ...
                data
                        .setMessage("Couldn't remove the required access session.");
                session.setAttribute(AdminErrorPageData.ATT_NAME, data);
                ret = "admin/ErrorPage.jsp";
