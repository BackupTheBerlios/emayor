 ...
 * @author tku
 */
public class AdminRemoveServiceSessionProcessor extends
        AbstractRequestProcessor {
    private final static Logger log = Logger
            .getLogger(AdminRemoveServiceSessionProcessor.class);
    ...
    public String process(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (session == null) {
            ...
            try {
                ...
                admin.removeServiceSession(ssid);
                admin.remove();
                ...
                data
                        .setMessage("Couldn't remove the required service session.");
                session.setAttribute(AdminErrorPageData.ATT_NAME, data);
                ret = "admin/ErrorPage.jsp";
