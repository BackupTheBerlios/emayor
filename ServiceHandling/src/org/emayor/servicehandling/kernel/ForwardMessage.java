...
public class ForwardMessage implements IForwardMessage {
    ...
    public void setDocuments(org.emayor.servicehandling.kernel.bpel.forward.data.ArrayOfStrings documents) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ForwardMessage)) return false;
        ...
        _equals = true && 
            ...
            ((this.replyAddress==null && other.getReplyAddress()==null) || 
             (this.replyAddress!=null &&
              this.replyAddress.equals(other.getReplyAddress()))) &&
            ((this.replyID==null && other.getReplyID()==null) || 
             (this.replyID!=null &&
              this.replyID.equals(other.getReplyID()))) &&
            ((this.replyService==null && other.getReplyService()==null) || 
             (this.replyService!=null &&
              this.replyService.equals(other.getReplyService()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ForwardMessage.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sh.forward.emayor.org", "ForwardMessage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("documents");
        elemField.setXmlName(new javax.xml.namespace.QName("http://sh.forward.emayor.org", "documents"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://emayor.org/IForward", "ArrayOf_xsd_string"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("replyAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("http://sh.forward.emayor.org", "replyAddress"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("replyID");
        elemField.setXmlName(new javax.xml.namespace.QName("http://sh.forward.emayor.org", "replyID"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("replyService");
        elemField.setXmlName(new javax.xml.namespace.QName("http://sh.forward.emayor.org", "replyService"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://sh.forward.emayor.org", "type"));
