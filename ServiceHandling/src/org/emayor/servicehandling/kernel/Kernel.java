...
public class Kernel implements IKernel {
	 ...
	 */
	public synchronized String getNumberOfInstances(String serviceId) throws KernelException {
		log.debug("-> start processing ...");
		String ret = "0";
		try {
	 ...
	 */
	public synchronized HashMap getNumberOfInstancesMap() throws KernelException {
		log.debug("-> start processing ...");
	 ...
	 */
	public synchronized void resetNumberOfInstances(String serviceId) throws KernelException {
		log.debug("-> start processing ...");
		try {
