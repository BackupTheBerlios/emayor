...
<table border="0" width="800">
  ...
  <tr> 
    <td colspan="3"> <div align="center"><strong><font size="4">Service session details:</font></strong> 
      </div></td>
  </tr>
  <tr> 
    <td colspan="3"> 
        ...
        <tr bgcolor="#CCCCCC"> 
          ...
          <div align="left"><strong>Attribute value </strong></div></td>
			...
			<%
				ServiceSessionInfo info = (ServiceSessionInfo)session.getAttribute("SERVICE_SESSION_INFO");
			%>	
			<tr>
				<td>Session id</td>
			...
			<tr>
				<td>Access session id</td>
				<!-- <td><a href="../adm?action=LOOKUP_ACCESS_SESSION&ASID=<%= info.getAsid() %>"><%= info.getAsid() %></a></td> -->
				<td><%= info.getAsid() %></td>
			</tr>
			<tr bgcolor="#FFCCCC">
				<td>Service id</td>
          ...
          <td colspan="2"> <div align="center">
		  	<form action="../adm" method="post">
				<input name="SSID" value="<%= info.getSessionId() %>" type="hidden"/>
				<input name="action" value="REMOVE_SERVICE_SESSION" type="hidden"/>
