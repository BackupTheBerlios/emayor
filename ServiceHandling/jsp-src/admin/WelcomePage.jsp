...
<table border="0" width="800">
  ...
  <tr> 
    <td colspan="3"> 
        ...
        <tr>	
          ...
          <td>- <a href="../adm?action=SHOW_SYSTEM_CONFIGURATION"><font size="2">View the active platform configuration ...</font></a></td>
			</tr>
			<tr>
				
          <td>- <a href="../adm?action=EDIT_SYSTEM_CONFIGURATION"><font size="2">Edit the active platform configuration / Create a new one...</font></a></td>
			</tr>
			<tr>
				
          <td>- <a href="../adm?action=SWITCH_SYSTEM_CONFIGURATION"><font size="2">Switch to an existant platform configuration ...</font></a></td>
			</tr>
  ...
  <tr> 
    ...
    <td width="787" bgcolor="#99CCFF"> <div align="center"><a href="../adm?action=LOGOUT"><font size="2">EXIT</font></a></div></td>
