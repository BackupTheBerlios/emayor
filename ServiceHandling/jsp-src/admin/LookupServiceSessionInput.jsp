...
<table border="0" width="800">
  ...
  <tr> 
    <td colspan="3"> <div align="center"><strong><font size="4">Lookup service session:</font></strong> 
      </div></td>
  </tr>
  <tr> 
    <td colspan="3"> 
		<form action="../adm" method="post">
		<input type="hidden" name="action" value="LOOKUP_SERVICE_SESSION"/>
        ...
        <tr bgcolor="#CCCCCC"> 
          ...
          <td width="568"> 
			...
			<tr>
				<td>Session id</td>
				<td>
					<input name="SSID" type="text" value="" maxlength="" size="40"/>
					<%
						String[] ids = (String[])session.getAttribute("SERVICE_SESSION_ID_ARRAY");
  ...
  <tr> 
    ...
    <td width="787" bgcolor="#99CCFF"> <div align="center"><a href="../adm?action=logout"><font size="2">logout</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../adm?action=mainmenu"><font size="2">menu</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../adm?action=LOOKUP_SERVICE_SESSION_INPUT"><font size="2">refresh it</font></a></div></td>
