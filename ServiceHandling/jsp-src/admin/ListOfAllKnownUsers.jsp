...
<head>
	<title>Listing of all known users.</title>
</head>
...
<table border="0" width="800">
  ...
  <tr> 
    <td colspan="3"> <div align="center"><strong><font size="4">All known users:</font></strong> 
      </div></td>
  </tr>
  <tr> 
    <td colspan="3"> 
  ...
  <tr> 
    ...
    <td width="787" bgcolor="#99CCFF"> <div align="center"><a href="../adm?action=logout"><font size="2">logout</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../adm?action=mainmenu"><font size="2">menu</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../adm?action=LIST_KNOWN_USERS"><font size="2">refresh list</font></a></div></td>
