...
%>
  ...
  <tr> 
    <td colspan="3"> <div align="left"><strong><font size="4">Please, choose a Rule to manage:</font></strong> 
      </div></td>
  </tr>
  <tr> 
    <td colspan="3"> 
...
<!-- List Policies -->
<%
	java.util.List RuleSet = (java.util.List)session.getAttribute("Rules");
    if (RuleSet!=null) {
		java.util.Iterator it = RuleSet.iterator();
		while (it.hasNext()) {
			String MyName = (String)(it.next());
			String MyEffect = (String)(it.next());
			%>
				<tr>
				<td>
						- <a href="../admpe?action=ChangeRule&RuleID=<%=MyName%>"><font size="2"><%=MyName%> :: Effect = <%=MyEffect%></font></a>
				</td> 
				</tr>
			<%
		}
			...
			%>	<tr>
				<td>
					- <a href="../admpe?action=Start"><font size="2">List Loaded Policies</font></a>
				</td>
				</tr> <%
}
%>
